					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<nav class="link-effect-2" id="link-effect-2">
							<ul class="nav navbar-nav">
								<li><a href="MainHome.jsp" class="effect-3">Home</a></li>
								<li class="dropdown">
									<a href="services.jsp" class="dropdown-toggle effect-3" data-toggle="dropdown">Services <b class="caret"></b></a>
								...
								<li><a href="" class="effect-3">Events</a></li>
	...
	<div class="services-breadcrumb_w3layouts">
		<div class="inner_breadcrumb">
			...
			<ul class="short_w3ls"_w3ls>
				<li><a href="MainHome.jsp">Home</a><span>|</span></li>
				<li>Register</li>
			</ul>
		</div>
	</div>
				...
				<div class="signin-form">
					<div class="login-form-rec">
						<form action="#" method="post">
							...
							<input type="text" name="dob" placeholder="DD-MM-YYYY" onchange="validatedate(this)" required="">
							<select id="country13" name="category" onchange="change_country(this.value)" class="frm-field required">
														<option value="null">Category</option>
														<option>Student</option>
													 <option>Health</option>
														<option>Women and Child</option>
							</select>	
							<input type="text" name="phone" placeholder="Phone number" onchange="Phone(this)" required="" >			
							<input type="email" name="email" placeholder="E-mail" required="">
							
							
							<input type="password" name="password" id="password1" placeholder="Password" required="">
							<input type="password" name="cpassword" id="password2" placeholder="Confirm Password" required="">
...
try
{
	...
	String sql= "insert into Registration(firstname,lastname,gender,dob,category,email,phonenumber,password,role) values('"+fn+"','"+ln+"','"+gen+"','"+dob+"','"+cate+"','"+email+"','"+phn+"','"+pass+"','"+"USER"+"')";
